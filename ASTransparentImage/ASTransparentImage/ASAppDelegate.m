...
@property (nonatomic, readonly) ASMainViewController *mainViewController;
...
- (ASMainViewController *)mainViewController
{
	if (!_mainViewController) {
		_mainViewController = [[ASMainViewController alloc] initWithoutNib];
	}
